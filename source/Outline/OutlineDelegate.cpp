...
bool
OutlineViewDelegate::handleRowSelected(OutlineNode* node)
{
    /*
...
bool 
OutlineViewDelegate::handleCollapse(OutlineNode* node)
{
...
bool 
OutlineViewDelegate::handleExpanded(OutlineNode* node)
{
...
void 
OutlineViewDelegate::draw(OutlineNode* node, Graphics* g, XRectangle rectangle)
{
    initImages(g);
